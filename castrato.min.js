// MIT license-castrato-©2014 Pehr Boman <github.com/unkelpehr>
...
d){var b,c,e=[n,d,d.length];(h[a]||(h[a]=[])).push(e);if(k[a])for(b=0,e=[e];c=k[a][b++];)f(0,0,c[0],c[1],e);return this},off:function(a,d){var b,c=0,e=h[a];if(e)for(;b=e[c++];)b[0]!==n||d&&d!==b[1]||e.splice(--c,1);return this},destroy:function(){g=0;h={}}}}}());